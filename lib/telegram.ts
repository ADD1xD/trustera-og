/**
 * Telegram notification utility for Trustera
...
export async function notifyNewSubmission(
  ...
  const message = `
🎯 <b>NEW SUBMISSION ON TRUSTERA</b>

<b>Bounty:</b> ${escapeHtml(bountyTitle)}
<b>Prize:</b> ${prize} ETH
<b>Hunter:</b> <code>${hunterAddress}</code>

<a href="https://trustera.app/bounties/${bountyId}">View Submission →</a>
`;
